...
const BADGE: Record<BadgeType, { label: string; classes: string }> = {
  "full-time": { label: "Full-time", classes: "bg-zinc-900 text-white" },
  freelance: { label: "Freelance", classes: "bg-yellow-400 text-black" },
  internship: { label: "Internship", classes: "bg-zinc-100 text-zinc-600" },
};
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-zinc-900 font-nav group-hover:text-yellow-500 transition-colors">
                  {job.role}
                </p>
