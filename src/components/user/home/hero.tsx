    ...
    <section className="relative overflow-hidden mt-24">
      <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:justify-evenly">
        <div className="relative z-10 max-w-xl w-full text-center md:text-left px-4">
          <p className="flex items-center justify-center md:justify-start gap-2 text-yellow-700 font-medium">
            <span className="w-3 h-3 rounded-full bg-yellow-500 inline-block" />
            Welcome to UI/UX Club
          </p>

          <h1 className="text-5xl md:text-7xl font-black text-black leading-none mb-4 max-w-3xl">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            <button
              className="w-full sm:w-auto px-8 py-3.5 flex items-center justify-center gap-3 text-black font-semibold rounded-2xl transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-yellow-300/50 text-base"
              style={{
            ...
            <button
              className="w-full sm:w-auto px-8 py-3.5 flex items-center justify-center gap-3 text-black font-semibold rounded-2xl border-2 border-yellow-400 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-yellow-300/40 text-base"
              style={{
                background: "linear-gradient(to right, #FFF176, #FFD700)",
              }}
            >
              Explore Showcase <FaThLarge />
            </button>
          </div>
        </div>
